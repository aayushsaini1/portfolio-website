...
<span style="color: #e5a900;"> **Role:**</span> Senior UX Designer <br>
<span style="color: #e5a900;"> **Team:**</span> 1 Product Manager, Head of Design, CPO, 1 Engineering Manager, 2 Frontend Devs, 3 Backend Devs <br>
<span style="color: #e5a900;"> **Timeline:**</span> Nov 2025 – Jan 2026 <br>
<span style="color: #e5a900;"> **Platform:**</span> Josys — B2B SaaS Management & IGA Platform <br>
...
`[IMAGE PLACEHOLDER: Screenshot(s) of the "before" state — actions scattered across separate modules]`
...
Rather than starting from "what data do we have," the framing question was: *what does an IT admin need to act on today, and how would they naturally prioritize it?* This shaped the eventual ordering logic more than any single module's internal priority scheme.
